...
const faqs = [
  { q: "What plans do you offer?", a: "We have three managed presence plans: Online Presence Starter (R299/month) — a professional one-page presence to get your business visible online; Online Presence Business (R499/month) — a full multi-page presence with better SEO and lead capture; Business Visibility Growth (R699/month) — a complete multi-section presence with a blog and advanced SEO for long-term visibility. We also manage online stores — chat to us for a quote on those." },
  ...
  { q: "Is there a setup fee?", a: "Yes — it's called an activation fee, and it covers the design, build and launch of your online presence. On a yearly plan: Starter R299, Business R499, Growth R699. On a 6-month plan: Starter R449, Business R699, Growth R999. Importantly: your monthly management fee only starts once your presence is live — not while you wait for it to be built. No hidden costs after that." },
